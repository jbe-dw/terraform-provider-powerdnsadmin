...
type ClientService interface {
	CreateCryptokey(params *CreateCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*CreateCryptokeyCreated, error)

	DeleteCryptokey(params *DeleteCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*DeleteCryptokeyNoContent, error)

	GetCryptokey(params *GetCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*GetCryptokeyOK, error)

	ListCryptokeys(params *ListCryptokeysParams, authInfo runtime.ClientAuthInfoWriter) (*ListCryptokeysOK, error)

	ModifyCryptokey(params *ModifyCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*ModifyCryptokeyNoContent, error)
...
*/
func (a *Client) CreateCryptokey(params *CreateCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*CreateCryptokeyCreated, error) {
...
*/
func (a *Client) DeleteCryptokey(params *DeleteCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*DeleteCryptokeyNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetCryptokey(params *GetCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*GetCryptokeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListCryptokeys(params *ListCryptokeysParams, authInfo runtime.ClientAuthInfoWriter) (*ListCryptokeysOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ModifyCryptokey(params *ModifyCryptokeyParams, authInfo runtime.ClientAuthInfoWriter) (*ModifyCryptokeyNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
